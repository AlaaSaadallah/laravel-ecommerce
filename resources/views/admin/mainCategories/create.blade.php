                                    ...
                                    <form class="form" action="{{route('admin.mainCategories.store') }}" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="form-body">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="projectinput1"> اسم القسم {{__('messeges.'.$lang -> abbr)}} </label>
                                                        <input type="text" value="" id="name" class="form-control" placeholder="ادخل اسم القسم  " name="category[{{$index}}][name]">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="projectinput1"> أختصار اللغة {{__('messeges.'.$lang -> abbr)}} </label>
                                                        <input type="text" value="" id="name" class="form-control" placeholder="ادخل أختصار اللغة  " name="category[{{$index}}][abbr]">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group mt-1">
                                                        ...
                                                        <label for="switcheryColor4" class="card-title ml-1">الحالة {{__('messeges.'.$lang -> abbr)}}</label>
